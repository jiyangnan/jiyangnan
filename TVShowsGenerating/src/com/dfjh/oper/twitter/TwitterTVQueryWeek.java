...
public class TwitterTVQueryWeek {
		...
		try {
			...
			if(judgeMapList!=null && judgeMapList.size()>1){
				...
				String channelSql = "SELECT a.*,a.id as top_id, "
						...
						+ "ON a.id = b.pid  where b.week IS NOT NULL and a.level='1' and b.week ='"+WeekNow+"' GROUP BY id";
...
//		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
//		Date date = new Date();
//		new TwitterTVQueryWeek().operFromTemp("2015-09-15", setNum);
//	}
}
