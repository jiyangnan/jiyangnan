...
public class ChannelQueryFaceBook {
	...
	public void oper(String time,int setNum){
		...
		String sqlBlog = "SELECT CHANNEL from wk_facebook_data_channel_date where DATETIME = '"+time+"'";
	...
	public void operNew(String time,int setNum){
		...
		if(CollectionUtils.isEmpty(list)){
			if(time.equals("2015-08-23")){
				...
				System.out.println("查询表为："+"wk_facebook_data_"+paramYear+"_"+paramWeek+"    传入time为："+time);
