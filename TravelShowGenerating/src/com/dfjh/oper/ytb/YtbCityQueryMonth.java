 ...
 */
public class YtbCityQueryMonth {
		...
		try {
			...
			if(judgeMapList!=null && judgeMapList.size()>1){
				...
				String channelSql = "SELECT a.*,a.id as top_id, b.month as month, "
						...
						+ "LEFT JOIN ufeng_ytb_tops_channel_count_month as b "
						+ "ON a.id = b.pid WHERE a.level='2' and b.month ='"+lastMonthStr+"' GROUP BY id";
				...
				DBUtil.addListMapForTVCount(channelMapList, "ufeng_ytb_tops_class_count_month");
...
//		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
//		Date date = new Date();
//		new YtbTVQueryMonth().operFromTemp("2015-09-15", setNum);
//	}
}
