package com.dfjh.db.utils.travelCycle;
...
//		Date date = new Date();
//		System.out.println(tu.getWeekOfYearFR(sdf.parse("2015-09-27")));
//		System.out.println(tu.getWeekOfYearUS(sdf.parse("2015-09-27")));
//	}
}
