...
public class MainTest {
	public  void doPublish() {
		...
		String setDate = null;
		String SQLTYB = "select update_time from ufeng_ytb_tops_class_count_day order by update_time desc limit 0,10";
		List<Map<String,Object>> listYTB = new ArrayList<Map<String,Object>>();
		
		String SQLTwitter = "select update_time from ufeng_twitter_tops_class_count_day order by update_time desc limit 0,10";
		List<Map<String, Object>> listTwitter= new ArrayList<Map<String,Object>>();
		
		String SQLFacebook = "select update_time from ufeng_facebook_tops_class_count_day order by update_time desc limit 0,10";
		List<Map<String, Object>> listFacebook= new ArrayList<Map<String,Object>>();
		
		String SQLGgplus = "select update_time from ufeng_ggplus_tops_class_count_day order by update_time desc limit 0,10";
