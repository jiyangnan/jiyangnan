	...
	public void oper(String time){
		...
		if(CollectionUtils.isEmpty(list)){
			...
			String sql = "SELECT e.CHANNEL,  e.WEEKNUM, " +
					...
					"e.UPLOADTIME  FROM  wk_facebook_data_channel_date_day_new_news e " +
					"WHERE DATETIME IN('"+monday+"','"+tuesday+"','"+wensday+"','"+thursday+"','"+friday+"','"+saturday+"','"+sunday+"') AND UPLOADTIME>= DATE_ADD('"+monday+"',INTERVAL -100 DAY) GROUP BY CHANNEL";
			...
			System.out.println("wk_facebook_data_channel_date_week 表中对应此周数据已经生成！");
