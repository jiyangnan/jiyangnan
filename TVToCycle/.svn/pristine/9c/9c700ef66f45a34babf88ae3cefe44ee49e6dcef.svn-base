	...
	public void oper(String time){
		...
		if(CollectionUtils.isEmpty(list)){
			...
			String sql = "SELECT e.CHANNEL, e.MONTHNUM , " +
					...
					"e.DATETIME ,e.UPLOADTIME  FROM  " +
					"wk_ytb_data_channel_date_day_new_news e " +
					"WHERE DATETIME >( DATE_ADD('"+finalDay+"',INTERVAL -"+totalDay+" DAY) ) " +
					"AND DATETIME< '"+finalDay+"' GROUP BY CHANNEL";
